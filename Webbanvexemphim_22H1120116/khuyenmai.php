...
<div class="container" id ="container">
    <div id="outer2">
        <div class="inf">
            <span style="color:#EA388B;text-align: center;font-size: large;"><h1>Coming Soon !!!</h1></span>  
            <img src="/22H1120116_TRANLEMINHTAN/HINH/Jeanne.jpg" height=400px width = 400px>
        </div>
